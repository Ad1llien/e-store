...
EMAIL_HOST_USER = 'akadilzh2004kz@gmail.com'  # Ваш email
EMAIL_HOST_PASSWORD = 'bsoa tane zrjz geys'  # Пароль приложения Gmail
DEFAULT_FROM_EMAIL = 'akadilzh2004kz@gmail.com'  # Адрес отправителя
